...
CHECKPOINT="/scratch/ngangada/thesis/thesis/verl/checkpoints/puzzle_3b_reinforce_plusplus/reinforce_plusplus_baseline/global_step_260/actor"

OUTPUT_DIR="/scratch/ngangada/thesis/thesis/verl/eval_results/reinforce_plusplus_hybrid_260"
