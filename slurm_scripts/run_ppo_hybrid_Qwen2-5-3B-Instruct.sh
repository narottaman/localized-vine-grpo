...
#SBATCH -o output/verl_ppo_hybrid_puzzlebarron3b.%j.out
#SBATCH -e output/verl_ppo_hybrid_puzzlebarron3b.%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ngangada@asu.edu
#SBATCH --export=NONE

# =====================================================================
# Hybrid Reward + Standard PPO
# Rewards table + structure + reasoning + format
# =====================================================================
...
python -m verl.trainer.main_ppo \
  ...
  trainer.project_name=puzzle_3b_hybrid \
  trainer.experiment_name=ppo_hybrid \
  trainer.resume_mode=auto \
  2>&1 | tee $SCRATCH/verl_logs/ppo_hybrid_puzzlebaron3b.log