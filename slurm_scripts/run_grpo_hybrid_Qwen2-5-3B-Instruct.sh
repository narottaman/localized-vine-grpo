...
#SBATCH -o output/verl_grpo_hybrid_puzzlebarron3b.%j.out
#SBATCH -e output/verl_grpo_hybrid_puzzlebarron3b.%j.err
...
# =====================================================================
# Hybrid Reward + GRPO
# Current reward function with structure + reasoning + table checking
# =====================================================================
...
python -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=grpo_hybrid \
  trainer.resume_mode=auto \
  2>&1 | tee $SCRATCH/verl_logs/grpo_hybrid_puzzlebaron3b.log