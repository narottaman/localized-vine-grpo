...
#SBATCH -o output/verl_grpo_pure_orm_puzzlebarron3b.%j.out
#SBATCH -e output/verl_grpo_pure_orm_puzzlebarron3b.%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ngangada@asu.edu
#SBATCH --export=NONE

# =====================================================================
# Pure ORM + GRPO (Group Relative Policy Optimization)
...
python -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=grpo_pure_orm \
  trainer.resume_mode=auto \
  2>&1 | tee $SCRATCH/verl_logs/grpo_pure_orm_puzzlebaron3b.log