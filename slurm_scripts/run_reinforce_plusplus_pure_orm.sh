...
#SBATCH -o output/verl_rein++_pure_orm_puzzlebarron3b.%j.out
#SBATCH -e output/verl_rein++_pure_orm_puzzlebarron3b.%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ngangada@asu.edu
#SBATCH --export=NONE

# =====================================================================
# REINFORCE++ with Pure ORM Rewards
# Test if REINFORCE++ also struggles with Pure ORM vs Hybrid
# =====================================================================
...
python -m verl.trainer.main_ppo \
  ...
  trainer.project_name=puzzle_3b_reinforce_plusplus_orm \
  trainer.experiment_name=reinforce_plusplus_pure_orm \
  2>&1 | tee $SCRATCH/verl_logs/reinforce_plusplus_pure_orm.log