...
#SBATCH -o output/verl_vineppo_puzzlebarron3b_eot.%j.out
#SBATCH -e output/verl_vineppo_puzzlebarron3b_eot.%j.err
...
python -m verl.trainer.main_ppo \
  ...
  actor_rollout_ref.rollout.response_length=2408 \
  ...
  +trainer.mc_k=1 \
  trainer.project_name=puzzle_3b_vineppo_v2_stepwise \
  trainer.experiment_name=vineppo_fixed_stepwise_ter \
  2>&1 | tee $SCRATCH/verl_logs/vine_ppo_puzzlebaron3b_vineppo_fixed_stepwise_1.log
